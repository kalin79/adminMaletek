                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group overflow-auto vh-75 ">
                                                ...
                                                <label class="field select">
                                                    <select id="cmb_rubros" name="rubros_id[]" multiple="" class=" form-control " placeholder="Seleccione rubro" style="width: 100% !important">
                                                        <option></option>
                                                        @foreach ($rubros as $rubro)
                                                            <option value="{{$rubro->id}}" @if(in_array($rubro->id,$rubros_producto)) selected @endif> {{$rubro->nombre}}</option>
                                                        @endforeach
                                                    </select>
                                                </label>
                                            </div>
                                                ...
                                                <label class="field select">
                                                    <select id="cmb_tipo_cerradura" name="tipo_cerraduras_ids[]" multiple="" class=" form-control " placeholder="Seleccione" style="width: 100% !important">
                                                        ...
                                                        @foreach ($tipos_cerradura as $tipo_cerradura)
                                                            <option value="{{$tipo_cerradura->id}}" @if(in_array($tipo_cerradura->id,$cerradura_producto)) selected @endif>{{$tipo_cerradura->name}}</option>
                                                        @endforeach
                                                    </select>
                                                </label>
                                            </div>
