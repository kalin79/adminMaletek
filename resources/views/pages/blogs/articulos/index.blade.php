    ...
    <div class="page-title-wrapper">
                    ...
                    <nav class="" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">
                                <a href="{{ $breadcrumb[0]['url'] }}">{{ $breadcrumb[0]['name'] }} </a> / {{$blog->titulo}}
                            </li>
        ...
        <div class="page-title-actions">
            ...
            <div class="d-inline-block" style="background: white">
                <a href="{{ route('blog.articulo.create',$blog->id) }}" data-id="{{$blog->id}}" data-name="{{$blog->titulo}}" class="btn btn-outline-2x btn-outline-primary entity-create ">
...
@push('scripts')
    ...
    <script>
        var url_articulo_load = "{{ route('blog.articulo.load',$blog->id) }}";
    </script>
    ...
    <script src="{{ asset('app/blogs/index-articulo.js') }}"></script>
