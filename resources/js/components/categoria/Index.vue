<template>
     <div class="categoriaPage">
          <banner-interno :category="category"></banner-interno>
          <div class="container">
     ...
     methods: {
          ...
          async dameFiltros(){
               try{
                    ...
                    let sendSolicitud = await axios.get('http://admin.maletek.com.pe/api/v1/get-filters')
          ...
          async loadApiCategories(){
               try{
                    let sendSolicitud = await axios.get(`http://admin.maletek.com.pe/api/v1/list-products/${this.slug}`,)
                    // console.log(sendSolicitud)
                    if (sendSolicitud.data.code === 200){
