...
Route::group(['as' => 'frontend.'], function () {
    ...
    Route::get('/', "frontend\InicioController@index")->name('index');
    Route::get('/categoria/{name}', "frontend\CategoriaController@index")->name('categoria');
    Route::get('/rubro/{name}', "frontend\CategoriaController@rubro")->name('rubro');
    Route::get('/producto/{name?}', "frontend\ProductoController@index")->name('producto');
    Route::get('/contactenos', "frontend\ContactoController@contacto")->name('contacto');
    Route::get('/acerca-de-nosotros', "frontend\InicioController@somos")->name('somos');
...
Route::group(['prefix' => 'admin'], function () {
    ...
    Route::middleware(['auth'])->group(function () {
        ...
        Route::post('blog/{blog}/articulo/store', "ArticuloController@store")->name('blog.articulo.store');
        Route::get('blog/articulo/edit/{articulo}', "ArticuloController@edit")->name('blog.articulo.edit');
        Route::post('blog/articulo/update/{articulo}', 'ArticuloController@update')->name('blog.articulo.update');
