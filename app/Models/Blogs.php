...
class Blogs extends Model
{
     ...
     */
    protected $fillable = [
        'titulo', 'slug', 'sub_titulo', 'imagen_banner', 'imagen_banner_mobile',  'active','created_user_id','updated_user_id','deleted_user_id'
    ];
    ...
    {
        if ($images) {
            $destinationPath = public_path('/images/blogs/'.$this->id);
